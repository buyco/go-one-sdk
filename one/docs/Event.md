...
`func NewEvent(eventCreatedDateTime time.Time, eventType string, eventClassifierCode string, eventDateTime string, transportEventTypeCode TransportEventTypeCode, transportCall TransportCall, equipmentEventTypeCode EquipmentEventTypeCode, emptyIndicatorCode EmptyIndicatorCode, ) *Event`
