...
// checks if the BaseEquipmentEventAllOfTransportCallID type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseEquipmentEventAllOfTransportCallID{}

// BaseEquipmentEventAllOfTransportCallID struct for BaseEquipmentEventAllOfTransportCallID
type BaseEquipmentEventAllOfTransportCallID struct {
}
...
func NewBaseEquipmentEventAllOfTransportCallID() *BaseEquipmentEventAllOfTransportCallID {
	this := BaseEquipmentEventAllOfTransportCallID{}
	return &this
}
...
func (o BaseEquipmentEventAllOfTransportCallID) MarshalJSON() ([]byte, error) {
...
func (o BaseEquipmentEventAllOfTransportCallID) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	return toSerialize, nil
}

type NullableBaseEquipmentEventAllOfTransportCallID struct {
	value *BaseEquipmentEventAllOfTransportCallID
	isSet bool
}

func (v NullableBaseEquipmentEventAllOfTransportCallID) Get() *BaseEquipmentEventAllOfTransportCallID {
	return v.value
}

func (v *NullableBaseEquipmentEventAllOfTransportCallID) Set(val *BaseEquipmentEventAllOfTransportCallID) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseEquipmentEventAllOfTransportCallID) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseEquipmentEventAllOfTransportCallID) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseEquipmentEventAllOfTransportCallID(val *BaseEquipmentEventAllOfTransportCallID) *NullableBaseEquipmentEventAllOfTransportCallID {
	return &NullableBaseEquipmentEventAllOfTransportCallID{value: val, isSet: true}
}

func (v NullableBaseEquipmentEventAllOfTransportCallID) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseEquipmentEventAllOfTransportCallID) UnmarshalJSON(src []byte) error {
	v.isSet = true
