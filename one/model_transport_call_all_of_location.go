...
// checks if the TransportCallAllOfLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransportCallAllOfLocation{}

// TransportCallAllOfLocation struct for TransportCallAllOfLocation
type TransportCallAllOfLocation struct {
...
func NewTransportCallAllOfLocation() *TransportCallAllOfLocation {
	this := TransportCallAllOfLocation{}
	return &this
}
...
func (o TransportCallAllOfLocation) MarshalJSON() ([]byte, error) {
...
func (o TransportCallAllOfLocation) ToMap() (map[string]interface{}, error) {
...
type NullableTransportCallAllOfLocation struct {
	value *TransportCallAllOfLocation
	isSet bool
}

func (v NullableTransportCallAllOfLocation) Get() *TransportCallAllOfLocation {
	return v.value
}

func (v *NullableTransportCallAllOfLocation) Set(val *TransportCallAllOfLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableTransportCallAllOfLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableTransportCallAllOfLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransportCallAllOfLocation(val *TransportCallAllOfLocation) *NullableTransportCallAllOfLocation {
	return &NullableTransportCallAllOfLocation{value: val, isSet: true}
}

func (v NullableTransportCallAllOfLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransportCallAllOfLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
